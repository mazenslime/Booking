...
export default function Room(){
    ...
    return(
        ...
        <div className='pl-10 py-10 w-3/4 flex flex-col gap-y-6'>
            <INFO Room={room} contact={room?.hotel?.contact} address={room?.hotel?.city} Location={room?.hotel?.location} rating={room?.hotel?.rating} reviews={room?.hotel?.reviews} name={room?.name} roomType={room['roomType']} price={room?.pricePerNight} isFavorite={isFavorite} onToggleFavorite={toggleFavorite} ref={overRif}  />
